...
const Login = () => {
  ...
  return (
      <div onClick={() => setShowUserLogin(false)} className='fixed top-0 right-0 left-0 bottom-0 z-30 flex items-center text-sm text-gray-600 bg-black/50'>
